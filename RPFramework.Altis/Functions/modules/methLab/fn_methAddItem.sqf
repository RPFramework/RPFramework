...
_idx = lbCurSel 1500;
if (_idx == -1) exitWith {ctrlSetText [1000, (localize "STR_RPF_MODULES_METHLAB_STATUS_NTA")];};
_classname = lbData [1500, _idx];
if (_classname == "") exitWith {ctrlSetText [1000, (localize "STR_RPF_MODULES_METHLAB_STATUS_NTA")];};
lbClear 1500;
lbClear 1501;
