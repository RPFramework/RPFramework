class sendMsg
{
	...
	class controls 
	{
		...
		{
			idc = 1600;
			text = $STR_RPF_MODULES_PHONE_SEND;
			x = 0.396875 * safezoneW + safezoneX;
		...
		{
			idc = 1601;
			text = $STR_RPF_MODULES_PHONE_MSGS;
		...
		{
			idc = 1602;
			text = $STR_RPF_MODULES_PHONE_ADDUPDATECONT;
			x = 0.396875 * safezoneW + safezoneX;
		...
		{
			idc = 1000;
			text = $STR_RPF_MODULES_PHONE_NAME;
			x = 0.396875 * safezoneW + safezoneX;
		...
		{
			idc = 1001;
			text = $STR_RPF_MODULES_PHONE_NUMBER;
		...
		{
			idc = 1003;
			text = $STR_RPF_MODULES_PHONE_CONTACT;
			x = 0.396875 * safezoneW + safezoneX;
			y = 0.412034 * safezoneH + safezoneY;
			w = 0.06875 * safezoneW;
			h = 0.0329871 * safezoneH;
		...
		{
			idc = 1603;
			text = $STR_RPF_MODULES_PHONE_SENDANON;
