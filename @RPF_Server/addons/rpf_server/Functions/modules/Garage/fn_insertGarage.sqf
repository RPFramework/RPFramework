...
_insert = [0, format["insertVehicle:%1:%2:%3:%4", typeOf _vehicle, getPlayerUID _player, ((getAllHitPointsDamage _vehicle) select 2), _krand]] call ExternalS_fnc_ExtDBquery;